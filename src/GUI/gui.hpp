...
void draw_gui(player_data &player) {
    RenderText(*shader,  "FPS: " + std::to_string(player.fps), 10.0f, 10.0f, 0.7f, glm::vec3(1.0f, 1.0f, 1.0f));
    ...
    // RenderText(*shader, cam_pos, 25.0f, 0.0f, 0.7f, glm::vec3(1.0, 1.0f, 1.0f));
    // RenderText(*shader, chunk_pos, 25.0f, 0.0f, 0.7f, glm::vec3(1.0, 1.0f, 1.0f));
    // RenderText(*shader, prev_chunk_pos, 25.0f, 0.0f, 0.7f, glm::vec3(1.0, 1.0f, 1.0f));
